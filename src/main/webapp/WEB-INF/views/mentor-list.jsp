...
<body>
	...
	<div class="container">
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<c:forEach var="mentor" items="${mentors}">
						<tbody>
							<tr>
								<td><a href="<c:url value="/mentors/${mentor.id}"/>"><c:out
											value="${ mentor.firstName }" /></a></td>


								<td><a href="<c:url value="/mentors/${mentor.id}"/>"><c:out
											value="${ mentor.lastName }" /></a></td>


								<td><a href="<c:url value="/mentors/${mentor.id}"/>"><c:out
											value="${ mentor.email  }" /></a></td>
		...
		<div class="action-bar">
			<p>
				Want to ba a Mentor?<a class="add-btn"
					href="<c:url value="/mentors/create"/>">Become a Mentor</a>
			</p>
		</div>
