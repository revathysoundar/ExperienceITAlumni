...
<body>
	...
	<div class="container">
		<form method="post" action="<c:url value="/questions/add"/>">
			<h1>Forum</h1>
			<div>
				<p>Please join the discussion! This forum covers Experience IT
					community news, and any questions students have in mind regarding
					program. You are welcome to benefit from it and post your questions
					and answers.</p>
			</div>
				...
				<table class="table table-striped">
					...
					<c:forEach var="question" items="${questions}">
						<tbody>
							<tr>
								<td style="width: 60%;"><p>
										<a href="<c:url value="/questions/${question.qId}"/>"><c:out
												value="${question.question}" /></a>
									</p></td>
								<td><p style="color: #337ab7;">
										Posted:
										<c:out value="${question.questionOwner}" />
									</p></td>
								<td><p style="color: #337ab7;">
										<c:set var="string1" value="${question.date}" />
