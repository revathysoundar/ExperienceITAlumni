...
<body>
	...
	to someone in their seat. We are thrilled to have this idea become more
	...
	<a href=" http://www.grandcircus.co">Click Here </a>

	<h3>GRAND CIRCUS DETROIT</h3>
	<p>1570 Woodward Avenue, Level 3 Detroit, MI 48226 (313) 338-2780
		hello@grandcircus.co</p>

	<!--  Footer Starts -->
	<div class="footer">
		<div class="row">
			<p align="center" style="padding: 30px;">Copyright &copy; 2016
				ExperienceIT Alumni. All rights reserved.</p>
		</div>
	</div>
